...
*/
    ...
    public void handleCreateVehicleNorth() {
        ...
        ImageView carImage = new ImageView(new Image(getClass().getResourceAsStream("/escenario2/Auto.png")));
...
//        trafficController.addVehicle(vehicle);
    ...
    public void handleCreateEmergencyVehicleNorth() {
        ...
        ImageView carImage = new ImageView(new Image(getClass().getResourceAsStream("/escenario2/AutoEmergencia.png")));
        carImage.setFitHeight(80);
        carImage.setFitWidth(60);
...
//        trafficController.addVehicle(vehicle);
    ...
    public void handleCreateVehicleWest() {
        ...
        ImageView carImage = new ImageView(new Image(getClass().getResourceAsStream("/escenario2/Auto02.png")));
        carImage.setFitHeight(80);
        carImage.setFitWidth(60);
